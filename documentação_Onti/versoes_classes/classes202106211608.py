...
##                        print(SQL)
    ...
    def memory(self):
        ...
        try:
            ...
            percentage = (int(valMem[1])*100)/int(valMem[0])
        except: percentage = '00'
        ...
        while tentativas < 4:
            ...
            while True:
                ...
                for r in resp:
                    ...
                    elif r['Valor_de_Inicializacao'] != None:
                        
                        vari.valor = r['Valor_de_Inicializacao']

                    else:
                        if vari.tipoVariavel.cod == 4:
            ...
            for conjVar in pacTVar:
                if type(conjVar) == list:
                    ...
                    if conjVar.tipoVariavel.tipo == 'ED' and self.entradasDigitais != None:
                        ...
                        try:
                            if conjVar.tipoValor.cod == 1 or conjVar.tipoValor.cod == 2:
                                ED[conjVar.nome] = int(conjVar.valor)

                        except:
                            print('Erros com o tipo de dados de entrada digital')
                        ...
                        try:
                            ...
                            print('Erros com o tipo de dados de saídas digitais')
                        ...
                        try:
                            if conjVar.tipoValor.cod == 2 or conjVar.tipoValor.cod == 4 or conjVar.tipoValor.cod == 6 or conjVar.tipoValor.cod == 7:
                                EA[conjVar.nome] = int(conjVar.valor)

                            elif conjVar.tipoValor.cod == 3:
                                EA[conjVar.nome] = float(conjVar.valor)
    
                        except:
                            print('Erros com o tipo de dados de entrada analogica')
                        ...
                        try:
                            if conjVar.tipoValor.cod == 2 or conjVar.tipoValor.cod == 4 or conjVar.tipoValor.cod == 6 or conjVar.tipoValor.cod == 7:
                                SA[conjVar.nome] = int(conjVar.valor)

                            elif conjVar.tipoValor.cod == 3:
                                SA[conjVar.nome] = float(conjVar.valor)
    
                        except:
                            print('Erros com o tipo de dados de saida analogica')
                        ...
                        try:
                            ...
                            if conjVar.tipoValor.cod == 1 or conjVar.tipoValor.cod == 2 or conjVar.tipoValor.cod == 4 or conjVar.tipoValor.cod == 6 or conjVar.tipoValor.cod == 7:
                            ...
                            print('Erros com o tipo de dados de internas de leitura')
                        ...
                        try:
                            if conjVar.tipoValor.cod == 1 or conjVar.tipoValor.cod == 2 or conjVar.tipoValor.cod == 4 or conjVar.tipoValor.cod == 6 or conjVar.tipoValor.cod == 7:
                                IC[conjVar.nome] = int(conjVar.valor)

                            elif conjVar.tipoValor.cod == 3:
                                IC[conjVar.nome] = float(conjVar.valor)

                            elif conjVar.tipoValor.cod == 5:
                                IC[conjVar.nome] = str(conjVar.valor)

                        except:

                            print('Erros com o tipo de dados de interichlor')
                        ...
                        try:
                            if conjVar.tipoValor.cod == 4 or conjVar.tipoValor.cod == 7:
                                SI[conjVar.nome] = int(conjVar.valor)

                            elif conjVar.tipoValor.cod == 3:
                                SI[conjVar.nome] = float(conjVar.valor)

                        except:

                            print('Erros com o tipo de dados de sensores inteligentes')
                        ...
                        try:
                            if conjVar.tipoValor.cod == 1 or conjVar.tipoValor.cod == 2 or conjVar.tipoValor.cod == 4 or conjVar.tipoValor.cod == 6 or conjVar.tipoValor.cod == 7:
                                IE[conjVar.nome] = int(conjVar.valor)

                            elif conjVar.tipoValor.cod == 3:
                                IE[conjVar.nome] = float(conjVar.valor)

                            elif conjVar.tipoValor.cod == 5:
                                IE[conjVar.nome] = str(conjVar.valor)

                        except:

                            print('Erros com o tipo de dados de internas de escrita')
