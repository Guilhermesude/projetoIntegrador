                ...
                if type(conjVar) == list:
                    ...
                    if conjVar.tipoVariavel.tipo == 'ED' and self.entradasDigitais != None:
                        ...
                        try:
                            ...
                            #print('IL[conjVar.nome]',IL[conjVar.nome])
                            print('conjVar.tipoValor.cod',conjVar.tipoValor.cod)
                            print('conjVar.valor',conjVar.valor)
                            print('conjVar.valor',type(conjVar.valor))
